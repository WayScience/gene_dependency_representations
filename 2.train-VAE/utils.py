#  THIS CODE WAS COPIED FROM THE FOLLOWING URL:https://github.com/broadinstitute/cell-painting-vae/blob/master/scripts/utils.py
...
def load_data(data_splits, dataset="cell painting"):
    ...
    for data_split in data_splits:
        if dataset == "cell painting":
            ...
            data[data_split] = pd.read_parquet(file, sep="\t")
        elif dataset == "L1000":
            file = pathlib.Path(
